...
edge_number_time = np.load("./uci/edge_number.npy")
...
neighborhood_reverse_ref_table = np.load("./uci_convLSTM/neighborhood_reverse_ref_table.npy")
...
node_embedding_cpu = np.load("./uci_convLSTM/node_embedding.npy")
node_number_time = np.load("./uci/node_number.npy")
edge_number_time = np.load("./uci/edge_number.npy")
