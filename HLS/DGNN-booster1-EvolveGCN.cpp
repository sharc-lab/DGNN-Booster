...
void load_weights() { // This function has been checked.
	printf("Loading weights for evolveGCN (RNN + GCN)...\n");

	FILE* f;
	f = fopen("../DGNN_parameters/EvolveGCN_weights/evolveGCN.bin", "rb");
	int number_count = 0;
...
void load_node_embedding() {
	FILE* f;
	f = fopen("../DGNN_parameters/uci_bin/node_embedding.bin", "rb");
	int number_count = 0;
	fseek(f, number_count * sizeof(float), SEEK_SET);
...
void load_edge_embedding() {
	FILE* f;
	f = fopen("../DGNN_parameters/uci_bin/edge_embedding.bin", "rb");
	int number_count = 0;
	fseek(f, number_count * sizeof(float), SEEK_SET);
...
void load_edge_info() {
	FILE* f;
	f = fopen("../DGNN_parameters/uci_bin/edge_info.bin", "rb");
	int number_count = 0;
	fseek(f, number_count * sizeof(float), SEEK_SET);
...
void load_edge_num() {
	FILE* f;
	f = fopen("../DGNN_parameters/uci_bin/edge_num.bin", "rb");
	int number_count = 0;
	fseek(f, number_count * sizeof(float), SEEK_SET);
...
void load_node_num() {
	FILE* f;
	f = fopen("../DGNN_parameters/uci_bin/node_num.bin", "rb");
	int number_count = 0;
	fseek(f, number_count * sizeof(float), SEEK_SET);
...
void load_renumbering_table() {
	FILE* f;
	f = fopen("../DGNN_parameters/uci_bin/neighborhood_ref_table.bin", "rb");
	int number_count = 0;
	fseek(f, number_count * sizeof(float), SEEK_SET);
...
void load_reverse_renumbering_table() {
	FILE* f;
	f = fopen("../DGNN_parameters/uci_bin/neighborhood_reverse_ref_table.bin", "rb");
	int number_count = 0;
	fseek(f, number_count * sizeof(float), SEEK_SET);
